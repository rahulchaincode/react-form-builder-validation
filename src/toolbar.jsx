...
export default class Toolbar extends React.Component {
  ...
  _defaultItems() {
    return [
      ...
      },
      {
        ...
        canHavePatternsToValidate: true,
        canHaveLengthToValidate: true,
        canHaveEmailToValidate: true,
      },
      {
        key: "NumberInput",
        canHaveAnswer: true,
  ...
  create(item) {
    ...
    if (item.key === "TextInput") {
      elementOptions.canHavePatternsToValidate =
        item.canHavePatternsToValidate !== false;
      elementOptions.canHaveEmailToValidate =
        item.canHaveEmailToValidate !== false;
      elementOptions.default_value = item.default_value;
      elementOptions.inputPattern = item.inputPattern;
      elementOptions.inputMin = item.inputMin;
      elementOptions.inputMax = item.inputMax;
    }

    if (item.key === "NumberInput") {
      elementOptions.canHaveLengthToValidate =
        item.canHaveLengthToValidate !== false;
      elementOptions.canHaveMobileToValidate =
        item.canHaveMobileToValidate !== false;
      elementOptions.default_value = item.default_value;
      elementOptions.inputMin = item.inputMin;
      elementOptions.inputMax = item.inputMax;
    }
