...
export default class FormElementsEdit extends React.Component {
  ...
  render() {
    ...
    const this_checked = this.props.element.hasOwnProperty("required")
      ...
      : false;
    const this_isEmail_checked = this.props.element.hasOwnProperty("isEmail")
      ? this.props.element.isEmail
      : false;
    const this_isMobile_checked = this.props.element.hasOwnProperty("isMobile")
      ? this.props.element.isMobile
      : false;
    ...
    const {
      ...
      canHaveOptionValue,
      canHavePatternsToValidate,
      canHaveLengthToValidate,
      canHaveMobileToValidate,
      canHaveEmailToValidate,
    } = this.props.element;
          ...
          <div className="form-group">
            ...
            {canHaveEmailToValidate && (
              <div className="custom-control custom-checkbox">
                ...
                />
                <label className="custom-control-label" htmlFor="isEmail">
                  Validate Email
                </label>
              </div>
            )}
            ...
            {canHaveMobileToValidate && (
              <div className="custom-control custom-checkbox">
                ...
                />
                <label className="custom-control-label" htmlFor="isMobile">
                  Validate Mobile
                </label>
              </div>
            )}
            ...
            {canHavePatternsToValidate && (
              <div className="form-group">
                <label className="control-label" htmlFor="inputPattern">
                ...
                <div className="row">
                  <div className="col-sm-12">
                    <input
                      ...
                      defaultValue={this.props.element.inputPattern}
                      onBlur={this.updateElement.bind(this)}
                      onChange={this.editElementProp.bind(
                        this,
                        "inputPattern",
            ...
            {canHaveLengthToValidate && (
              <div>
                <div className="form-group">
                  <label className="control-label" htmlFor="inputMin">
                    Min length
                  </label>
                  <div className="row">
                    <div className="col-sm-12">
                ...
                <div className="form-group">
                  <label className="control-label" htmlFor="inputMax">
                    Max length
                  </label>
                  <div className="row">
                    <div className="col-sm-12">
